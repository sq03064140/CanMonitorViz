...
class OBSTACLE{
public:
    OBSTACLE(float _x=0,float _y=0,float _head=0,OBSTACLE_TYPE _type=car,bool _valid=true,float _wheelbase=3.0,float _width=float(1.8),float _x_var=0,float _y_var=0,float _xy_var=0,OBSTACLE_LANE _lane=unknow_lane){
